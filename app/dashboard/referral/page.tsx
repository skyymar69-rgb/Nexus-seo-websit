      ...
      <div className="bg-white dark:bg-surface-900 rounded-xl border border-surface-200 dark:border-surface-800 p-6">
        ...
        <div className="space-y-4">
          {[
            ...
            { step: '2', title: 'Vos contacts s\'inscrivent', desc: 'Ils creent un compte gratuit sur Nexus SEO via votre lien.' },
            { step: '3', title: 'Gagnez des badges', desc: 'A chaque inscription, vous gagnez le badge Ambassadeur et des fonctionnalites exclusives a venir.' },
          ].map(item => (
